...
contract MyFirstEricFans is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    
    string public baseURI = "ipfs://QmThhFAN7DGZoRH9i8w5wxVqH3NeTGwuC936H1hPiXRS8N"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("EricFanwoos", "EFS") payable {
        // 剛開始我們先自己 Mint 一個
